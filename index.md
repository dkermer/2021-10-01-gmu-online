...
latitude: "38.834720"        # decimal latitude of workshop venue (use D)
longitude: "-77.312680"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Oct 1, 8, 15, 22"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "1:30 pm - 5:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: [ "Alyssa Fahringer", "Elaine Ding", "Debby Kermer", "Mike Trizna","Swabir Silayi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Carl Leak", "Wendy Mann", "Andrew Kierig", "Aishwarya Sharma"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["datahelp@gmu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2021-10-01-gmu-online # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
